...
const WORDLOCK_FONT = preload("res://assets/fonts/Jersey10-Regular.ttf")
...
func _handle_victory_shared():
	...
	close()
	get_tree().change_scene_to_file("res://ui/home_screen/home_screen.tscn")
...
func _build_kbc_ui(options: Array):
	...
	kbc_msg_label.add_theme_font_override("font", preload("res://assets/fonts/Jersey10-Regular.ttf"))
	...
	q_label.add_theme_font_override("font", preload("res://assets/fonts/Jersey10-Regular.ttf"))
	...
	lock_btn.add_theme_font_override("font", preload("res://assets/fonts/Jersey10-Regular.ttf"))
	...
	lifeline_label.add_theme_font_override("font", preload("res://assets/fonts/Jersey10-Regular.ttf"))
...
func _make_kbc_lifeline_btn(text: String) -> Button:
	...
	btn.add_theme_font_override("font", preload("res://assets/fonts/Jersey10-Regular.ttf"))
...
func _show_kbc_audience_popup(percentages: Array):
	...
	title.add_theme_font_override("font", preload("res://assets/fonts/Jersey10-Regular.ttf"))
	...
	for i in range(min(percentages.size(), 4)):
		...
		lbl.add_theme_font_override("font", preload("res://assets/fonts/Jersey10-Regular.ttf"))
	...
	close_btn.add_theme_font_override("font", preload("res://assets/fonts/Jersey10-Regular.ttf"))
...
func _show_kbc_phone_popup(friend_answer: String):
	...
	hint_label.add_theme_font_override("font", preload("res://assets/fonts/Jersey10-Regular.ttf"))
